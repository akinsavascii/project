...
Uygulamayı ücretsiz olarak 7/24 çalışır hale getirmek için:

1. Detaylı deployment rehberi için [`DEPLOYMENT.md`](DEPLOYMENT.md) dosyasına bakın
2. GitHub'a push yapın
3. [Render.com](https://render.com) hesabı oluşturun
4. Repository'nizi bağlayın ve deploy edin

**Ücretsiz Plan:** 750 saat/ay, otomatik deployment, HTTPS dahil
